...
$(function() {
    ...
    */
    describe('RSS Feeds', function() {
         ...
         * page?
         */
        it('Rss feed are defined', function() {
    ...
    describe('Initial Entries', function() {
        ...
        it('After LoadFeed is completed, there is atlease single .entry element', function(){
    ...
    describe('New Feed Selection', function() {
        ...
        beforeEach(function(done){
          ...
          it('Feed content changes from one to another',function(){
